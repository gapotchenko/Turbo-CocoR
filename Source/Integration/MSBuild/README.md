...
- Using `Gapotchenko.Turbo.CocoR.Integration.MSBuild` NuGet package as a development dependency in your project does not require the project to be licensed under the GNU General Public License
