...
- Using `Gapotchenko.Turbo.CocoR.Integration.MSBuild` NuGet package as a reference in your project does not require the project to be licensed under the GNU General Public License
