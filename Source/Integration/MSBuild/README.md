...
- Using `Gapotchenko.Turbo.CocoR.Integration.MSBuild` NuGet package in your project does not require the project to be licensed under GNU General Public License
